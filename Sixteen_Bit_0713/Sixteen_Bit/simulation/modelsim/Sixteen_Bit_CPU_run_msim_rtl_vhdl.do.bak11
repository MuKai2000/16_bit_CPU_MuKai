...
vcom -93 -work work {F:/Code/Quartus/Sixteen_Bit/SREG.vhd}

vcom -93 -work work {F:/Code/Quartus/Sixteen_Bit/TB/ms_ctrl.vhd}

vsim -t 1ps -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cycloneive -L rtl_work -L work -voptargs="+acc"  ms_ctrl
